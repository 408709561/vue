  ...
  <el-row>
    <el-col :span="8">
      <div class="filter-container">
        <el-button-group>
        <el-button type="primary" v-if="departManager_btn_add" icon="plus" @click="append">初始化</el-button>
      </el-button-group>
      </div>
          ...
          <div>
            <el-tabs value="first">
              <el-tab-pane label="用户管理" name="first">
                <div class="filter-container">
                  <el-input @keyup.enter.native="handlerTableRowFilter" style="width: 200px;" class="filter-item" placeholder="标签或code" v-model="listTableQuery.name">
                  </el-input>
...
export default {
  ...
  methods: {
    ...
    closeUserDialog(selects) {
      ...
      console.log(this.$refs.departUser)
